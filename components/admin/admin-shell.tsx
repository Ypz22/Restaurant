...
function Shell({
  ...
  return (
    <div className="min-h-dvh bg-background">
      <header className="sticky top-0 z-40 h-14 border-b border-inverse bg-inverse text-inverse-foreground">
        <div className="mx-auto flex h-full max-w-[1440px] items-center gap-2 px-4">
          <span className="text-label-lg">{restaurantName}</span>
          <span className="text-label-sm uppercase text-inverse-foreground/65">Administración</span>
      ...
      <div className="mx-auto flex min-h-[calc(100dvh-3.5rem)] max-w-[1440px]">
        <nav className="hidden w-52 shrink-0 border-r border-inverse bg-inverse p-2 xl:block" aria-label="Navegación de administración">
              ...
              return (
                <li key={href}>
                  <Link
                    ...
                    className={cn(
                      'flex items-center gap-2.5 rounded-lg px-3 py-2 text-label-md',
                      active ? 'bg-primary text-primary-foreground' : 'text-inverse-foreground/70 hover:bg-inverse-foreground/10 hover:text-inverse-foreground'
                    )}
                  >
        ...
        <nav
          className="fixed inset-x-0 bottom-0 z-40 flex border-t border-inverse bg-inverse xl:hidden"
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? 'text-primary' : 'text-inverse-foreground/65'
                )}
              >
        ...
        <main className="min-w-0 flex-1 p-4 pb-24 xl:pb-4">{children}</main>
      </div>
    </div>
  )
}
