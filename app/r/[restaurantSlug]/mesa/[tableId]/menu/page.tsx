...
function LiveMenu() {
  ...
  return (
    <BrasaShell slug={params.restaurantSlug} tableId={params.tableId} tableLabel={tableLabel} active={view === 'camarero' ? 'camarero' : 'menu'} count={count}><main className="sb-main">
